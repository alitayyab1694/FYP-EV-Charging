...
import projectLogo1 from '../../assets/images/logo-icon.png';
  ...
  return (
    <>
      <div className="app-sidebar--header">
        <div className="app-sidebar-logo">
          <NavLink
            ...
            <img
              ...
              src={sidebarToggle ? projectLogo1 : projectLogo}
            />
          </NavLink>
        </div>
        <button
        ...
        <button
          className={clsx(
            'navbar-toggler hamburger hamburger--elastic toggle-mobile-sidebar-btn is-active',
