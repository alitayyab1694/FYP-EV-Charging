...
export const SET_HEADER_DRAWER_TOGGLE_CUSTOMER =
  'THEME_OPTIONS/SET_HEADER_DRAWER_TOGGLE_CUSTOMERS';
...
export const setHeaderDrawerToggleCustomer = (headerDrawerToggleCustomer) => ({
  type: SET_HEADER_DRAWER_TOGGLE_CUSTOMER,
  headerDrawerToggleCustomer
});
...
export default function reducer(
  ...
  switch (action.type) {
    ...
    case SET_HEADER_DRAWER_TOGGLE_CUSTOMER:
      return {
        ...state,
        headerDrawerToggleCustomer: action.headerDrawerToggleCustomer
      };
